        ...
        <div className="login-section" style={{width:440,display:"flex",alignItems:"center",justifyContent:"center",padding:"32px 40px",borderLeft:"1px solid rgba(255,255,255,.06)"}}>
          <div style={{width:"100%"}}>
            ...
            <div style={{background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.1)",borderRadius:20,padding:28}}>
              ...
              <form onSubmit={e=>{e.preventDefault();go();}} autoComplete="on" style={{margin:0}}>
              ...
              <button type="submit" disabled={busy} style={{width:"100%",padding:"13px 0",borderRadius:10,border:"none",background:"linear-gradient(135deg,#0d9488,#14b8a6)",color:"#fff",fontSize:15,fontWeight:700,cursor:"pointer",fontFamily:"inherit",boxShadow:"0 4px 16px rgba(13,148,136,.4)"}}>
